...
{\color{blue}The essay is due in hard copy at the beginning of class, and no later than 8.15 AM (Central Time Zone) on {\bf {\input{/Users/hectorbahamonde/RU/Teaching/Comparative_Politics_UGRAD/date_paper.txt}\unskip}}}. Turning it in before the due date is OK, but \emph{not} afterwards. {\bf Late essays will not be accepted}, and will be graded with a $0$. There will \emph{not} be exceptions or extensions. No electronic copies of any kind will be accepted.
...
\begin{enumerate}
    \item {\input{/Users/hectorbahamonde/RU/Teaching/Teaching_Questions_Database/1.txt}\unskip} 
    \item {\input{/Users/hectorbahamonde/RU/Teaching/Teaching_Questions_Database/2.txt}\unskip}
\end{enumerate}
