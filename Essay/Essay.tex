...
\begin{enumerate}
    ...
    %\item Critics of quantitative work in political science have often  complained that social and political variables that are important in  political science simply cannot be accurately measured with  quantitative analysis. (1) How severe a problem do you believe  measurement error is in quantitative political science?  Will measurement error always undermine the validity of statistical research, or only under some conditions, and  if so which ones? Is qualitative work immune to these measurement issues? How so?
