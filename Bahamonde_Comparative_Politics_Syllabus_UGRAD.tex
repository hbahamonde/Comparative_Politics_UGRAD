...
This {\bf {\color{blue}undergraduate-level course}} offers an introduction to core concepts and theories in comparative politics subfield. The course is divided into parts: (1) An introduction to the subfield, and its research methods; (2) state, its origins and consequences; (3) democracy, dictatorship, regime change, electoral politics; (4) political development and colonialism.
\\
\\
...
\begin{enumerate}
	...
	\\
	\\
	You must take the exam at the scheduled time. There will be no make-ups, unless you have a documented medical excuse. (Documented) Medical excuses are the only type of exceptions will be accepted.
	\\
	\\
...
\vspace{2mm}{\bf {\color{blue}March 5: Distribute Essay Topics and Instructions in Class [no readings assigned].}}\vspace{2mm}
