...
\begin{enumerate}
	...
	\\
	\\
	When reading the class materials, you should locate the main argument, strengths, weaknesses, and other issues that are of concern. As you read through the material, think about the following questions: \emph{What is the cause and what is the effect? What makes the theory `move,' is it individuals? institutions? (or)rationality? Does/do the author/s have a strong research design/methodology to support the paper's argument?} 
	\\
	\\
	...
	\\
	\\
	You must take the exam at the scheduled time. There will be no make-ups, unless you have a documented medical excuse.
	\\
	\\
	The exam will be a closed-book exam, covering material from the entire semester, until February 23. The format of the exam will be discussed on February 23, when we will review the material for the test. Please note, exam questions will be drawn \emph{both} from the readings \emph{and} lectures.
	...
	\\
	\\
	Topics will be assigned by me on {\bf March 5}. The essay is due in hard copy at the beginning of class, and no later than 8.15 am on \underline{March 23}. Turning it in before the due date is OK, but not afterwards. There will not be exceptions or extensions. No electronic copies of any kind will be accepted.
	\\
	\\
	I encourage you to see my in my office hours \emph{before} the due date. If you want, \href{mailto:\filetext}{send me} your draft via email, then \href{https://calendly.com/bahamonde/officehours}{make an appointment}. That way I will be able to give you feedback on your work before the due date. If you want to receive comments from me, please allow plenty of time for me to read your draft, and time to meet you. Consider also that your classmates will do the same. Consequently, plan accordingly.

	\item {\bf One cumulative in-class final exam}: 35 \%. The cumulative final exam will be a closed-book exam covering material from the entire semester. The format of the exam will be discussed by the end of the semester. Exam questions will be drawn both from the readings and lectures. The final exam is set by the registrar. Hence, both place and time are TBA. There will not be exceptions. We will also schedule an in-class review session.
...
\vspace{2mm}{\bf {\color{blue}March 2: Midterm, same classroom, same time, [no readings assigned].}}\vspace{2mm}\\
...
\item {\bf Regime Change: Different Determinants and Explanations}
	...
	%	\item
		...
		\item {\bf March 9: Gaining Perspective: The Glorious Revolution in England [no readings assigned]}:
				\begin{itemize}
					\item[$\bullet$] \href{https://www.youtube.com/watch?v=_m0VG01w6lU}{Documentary} in class.
				\end{itemize}
...
\vspace{2mm}{\bf {\color{blue}Spring Break. Have fun. In the meantime, professor be presenting at the \emph{Western Political Science Association Conference} in San Francisco.}}\vspace{2mm}
...
\item {\bf Parties and Elections: Selected Topics}
	...
	\begin{itemize} 
		\item {\bf April 20: `Gaining Perspective'}
		\begin{itemize}
			\item[$\bullet$] In-class documentary `Street Fight' about the 2002 mayoral race in Newark, New Jersey.
		\end{itemize}
	\end{itemize}
